...
public final class ClientColorHandlers {
    ...
    public static void onBlockColors(RegisterColorHandlersEvent.Block event) {
        ...
        for (var funnel : java.util.List.of(ModBlocks.FUNNEL_WALL.get(), ModBlocks.FUNNEL_CORE.get())) {
    ...
    public static void onItemColors(RegisterColorHandlersEvent.Item event) {
        ...
        for (var funnel : java.util.List.of(ModItems.FUNNEL_WALL.get(), ModItems.FUNNEL_CORE_SMALL.get(),
